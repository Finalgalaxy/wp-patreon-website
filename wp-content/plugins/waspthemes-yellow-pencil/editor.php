...
<head>
	...
	if(isset($_GET['yp_type'])){
		if($_GET['yp_type'] == 'wordpress_panel'){
			$classesReturn .= ' yp-wordpress-admin-editing';
		}
	}

	if(isset($_GET['yp-template-id'])){
		$classesReturn .= ' yp-html-mod-active';
	}
...
<body class="<?php echo $classesReturn; ?>">
	...
	<?php
		if(isset($_GET['yp-template-id'])){
	?>
	<div class="html-editor-top-bar">

		<a class="yp-button yp-save-btn">Save</a>
			...
			<div class="yp-anim-controls">
				<div class="yp-anim-control-left">
					<div class="yp-anim-manager-control">
						<a class="yp-anim-control-btn yp-anim-control-close"><span class="dashicons dashicons-no-alt"></span></a>
