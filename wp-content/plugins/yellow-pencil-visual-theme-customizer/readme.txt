...
== Screenshots ==
1. Click any element that you want to edit. (Blue bordered paragraph selected in screenshot.)
2. Select any that you want to edit. There are so many settings.
2. Edit Fonts, sizes, positions and a lot more.
3. Select one of 600 Google fonts.
4. Color palettes and background settings.
5. Live CSS editor
